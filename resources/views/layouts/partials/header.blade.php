        ...
        <div class="header__content">
          ...
          <div class="header__menu">
            <ul class="header__nav">
              ...
              <li class="header__nav-item">
                <a href="{{ route('cars.show') }}" class="header__nav-link">Voitures</a>
              </li>
              <li class="header__nav-item">
          ...
          <div class="header__actions">
            ...
            <div class="header__action">
              <a class="header__action-btn" href="{{ route('cars.show') }}">
            ...
            <div class="header__action">
              ...
              <ul class="dropdown-menu header__profile-menu" aria-labelledby="dropdownMenuProfile">
                ...
                <li><a href="{{ route('cars.history') }}"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
