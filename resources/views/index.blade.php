  ...
  <section class="row row--grid">
    ...
    <div class="col-12">
      <div class="main__title main__title--first">
        ...
        <a href="cars.html" class="main__link">View more <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    <div class="col-12 col-md-6 col-xl-4">
      <div class="car">
        ...
        <div class="car__footer">
          ...
          <button class="car__favorite" type="button" aria-label="Add to favorite"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  ...
  <section class="row row--grid">
    ...
    <div class="col-12 col-md-6 col-xl-3">
      <div class="step1">
        ...
        <p class="step1__text">If you are going to use a passage of Lorem Ipsum, you need to be sure. <br><a href="signup.html">Get started</a></p>
      </div>
    </div>
    ...
    <div class="col-12 col-md-6 col-xl-3">
      <div class="step1">
        ...
        <p class="step1__text">Various versions have evolved over the years, sometimes by accident, sometimes on purpose</p>
      </div>
    </div>
    ...
    <div class="col-12 col-md-6 col-xl-3">
      <div class="step1">
        ...
        <p class="step1__text">It to make a type specimen book. It has survived not only five centuries, but also the leap into electronic</p>
      </div>
    </div>
    ...
    <div class="col-12 col-md-6 col-xl-3">
      <div class="step1">
        ...
        <p class="step1__text">There are many variations of passages of Lorem available, but the majority have suffered alteration</p>
      </div>
    </div>
  </section>
  <!-- end get started -->
