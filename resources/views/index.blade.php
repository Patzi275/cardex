        ...
        <div class="home__content">
          ...
          <form class="home__search" action="#">
            <div class="home__group">
              <label for="search_name">Voiture, model ou marque</label>
              <input type="text" name="name" id="search_name" placeholder="Quelle voiture cherchez vous?">
            </div>

            <div class="home__group">
              <label for="search_price">Prix journalier max</label>
              <input type="text" name="price" id="search_price" placeholder="Prix en FCFA">
            </div>

            <div class="home__group">
              <label for="make_year">Année de fabrication</label>
              <input type="text" name="make_year" id="search_make_year" placeholder="Date minimal de fabrication">
            </div>

            <button type="button"><span>Chercher</span></button>
          </form>
        </div>
      </div>
    </div>
